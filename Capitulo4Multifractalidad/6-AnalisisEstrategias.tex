...
\begin{itemize}
    ...
    \item Red D: Red obtenida del hongo Cerevisiae
\end{itemize}
...
\subsection{Red del hongo cerevisae}
...
\begin{enumerate}
    ...
    \item Dado que el tiempo requerido para la ejecución de los algoritmos es considerable (más de 24 horas), se requiere un soporte teórico para conocer el número de iteraciones óptimo para cada estrategia.
