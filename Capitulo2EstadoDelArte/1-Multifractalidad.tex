...
En la exploración del estado del arte no se evidencia la existencia de una herramienta comercial para usuario final para el análisis multifractal. Lo que se encuentra son implementaciones realizadas por los investigadores de este tema y un complemento para el software Matlab\cite{matlab}. En la tabla \ref{herramientasFractal} se pueden observar algunas de ellas:
